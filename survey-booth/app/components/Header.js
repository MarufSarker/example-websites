      ...
      <nav className="navbar navbar-default">
        <div className="container-fluid">
          <div className="navbar-header">
            ...
            <a className="navbar-brand" href="#">SurveyBooth</a>
          </div>
          ...
          <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul className="nav navbar-nav navbar-right">
              ...
              <li
                className={this.routeIsActive('/publicsurveys') ? 'active' : ''}>
                <Link to="publicsurveys">Public Surveys</Link>
              </li>
              {
                this.props.user ?
                (
                  <li
                    className={this.routeIsActive('/usersurveys') ? 'active' : ''}>
                    <Link to="usersurveys">Your Surveys</Link>
                  </li>
                ) : null
              }
